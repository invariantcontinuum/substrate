...
<!DOCTYPE html>
<#assign currentLanguageTag=(locale.currentLanguageTag)!((lang)!'en')>
<html class="${properties.kcHtmlClass!}" lang="${currentLanguageTag}"<#if realm.internationalizationEnabled> dir="${(locale.rtl)?then('rtl','ltr')}"</#if>>
...
<head>
    ...
    <script type="module" src="${url.resourcesPath}/js/menu-button-links.js"></script>
    <script type="module">
            ...
            <div class="${properties.kcInputClass!}">
              ...
              >
                <#list locale.supported?sort_by("label") as l>
                  <option
                    value="${l.url}"
                    ${(l.languageTag == currentLanguageTag)?then('selected','')}
                  >
                    ${l.label}
                  </option>
                </#list>
