...
const DARK: GraphPalette = {
  ...
  nodeSelectedFill:  "rgba(160, 189, 213, 0.22)",
  ...
  // Lifted slate/indigo hues against shadow-grey
  typeService:   "#a0bdd5",
  typeSource:    "#a0bdd5",
  typeDatabase:  "#9b93c6",
  typeCache:     "#b9b3d9",
  ...
  edgeDepends:       "rgba(160, 189, 213, 0.58)",
  edgeDependsArrow:  "rgba(160, 189, 213, 0.75)",
  edgeViolation:     "#e6706b",
  edgeEnforces:      "rgba(155, 147, 198, 0.58)",
  edgeEnforcesArrow: "rgba(155, 147, 198, 0.75)",
...
const LIGHT: GraphPalette = {
  ...
  nodeSelectedBorder:"#4d6c8a",
  nodeSelectedFill:  "rgba(124, 153, 180, 0.22)",
  ...
  spotlightFocusBorder: "#7c99b4",
  spotlightDimText:     "rgba(35, 31, 32, 0.55)",
  sourceParentBorder:   "rgba(124, 153, 180, 0.45)",
  sourceParentText:     "rgba(35, 31, 32, 0.55)",

  // Deeper slate/indigo hues against linen
  typeService:   "#4d6c8a",
  typeSource:    "#4d6c8a",
  typeDatabase:  "#494368",
  typeCache:     "#6b6492",
  ...
  edgeDepends:       "rgba(77, 108, 138, 0.55)",
  edgeDependsArrow:  "rgba(77, 108, 138, 0.72)",
  edgeViolation:     "#a43b3b",
  edgeEnforces:      "rgba(73, 67, 104, 0.55)",
  edgeEnforcesArrow: "rgba(73, 67, 104, 0.72)",
