"""CMake fixture test — build_graph over tests/fixtures/cmake/ == expected.json."""
...
def test_cmake_fixture_matches_golden(load_fixture: LoadFixtureFn) -> None:
    root, tree = load_fixture("cmake")
