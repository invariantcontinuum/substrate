"""C fixture test — build_graph over tests/fixtures/c/ == expected.json."""
...
def test_c_fixture_matches_golden(load_fixture: LoadFixtureFn) -> None:
    root, tree = load_fixture("c")
