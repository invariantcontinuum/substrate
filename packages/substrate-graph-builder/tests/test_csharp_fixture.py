"""C# fixture test — build_graph over tests/fixtures/csharp/ == expected.json."""
...
def test_csharp_fixture_matches_golden(load_fixture: LoadFixtureFn) -> None:
    root, tree = load_fixture("csharp")
