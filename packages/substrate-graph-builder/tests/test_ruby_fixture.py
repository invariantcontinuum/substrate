"""Ruby fixture test — build_graph over tests/fixtures/ruby/ == expected.json."""
...
def test_ruby_fixture_matches_golden(load_fixture: LoadFixtureFn) -> None:
    root, tree = load_fixture("ruby")
