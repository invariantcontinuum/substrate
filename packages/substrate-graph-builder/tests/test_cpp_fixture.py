"""C++ fixture test — build_graph over tests/fixtures/cpp/ == expected.json."""
...
def test_cpp_fixture_matches_golden(load_fixture: LoadFixtureFn) -> None:
    root, tree = load_fixture("cpp")
