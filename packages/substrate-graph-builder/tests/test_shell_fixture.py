"""Shell fixture test — build_graph over tests/fixtures/shell/ == expected.json."""
...
def test_shell_fixture_matches_golden(load_fixture: LoadFixtureFn) -> None:
    root, tree = load_fixture("shell")
