"""Perl fixture test — build_graph over tests/fixtures/perl/ == expected.json."""
...
def test_perl_fixture_matches_golden(load_fixture: LoadFixtureFn) -> None:
    root, tree = load_fixture("perl")
