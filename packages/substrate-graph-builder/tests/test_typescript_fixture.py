"""TypeScript fixture test — build_graph over tests/fixtures/typescript/ == expected.json."""
...
def test_typescript_fixture_matches_golden(load_fixture: LoadFixtureFn) -> None:
    root, tree = load_fixture("typescript")
