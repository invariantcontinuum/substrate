"""Java fixture test — build_graph over tests/fixtures/java/ == expected.json."""
...
def test_java_fixture_matches_golden(load_fixture: LoadFixtureFn) -> None:
    root, tree = load_fixture("java")
