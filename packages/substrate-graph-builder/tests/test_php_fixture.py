"""PHP fixture test — build_graph over tests/fixtures/php/ == expected.json."""
...
def test_php_fixture_matches_golden(load_fixture: LoadFixtureFn) -> None:
    root, tree = load_fixture("php")
