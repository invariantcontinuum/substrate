"""Rust fixture test — build_graph over tests/fixtures/rust/ == expected.json."""
...
def test_rust_fixture_matches_golden(load_fixture: LoadFixtureFn) -> None:
    root, tree = load_fixture("rust")
