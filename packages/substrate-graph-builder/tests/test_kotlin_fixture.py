"""Kotlin fixture test — build_graph over tests/fixtures/kotlin/ == expected.json."""
...
def test_kotlin_fixture_matches_golden(load_fixture: LoadFixtureFn) -> None:
    root, tree = load_fixture("kotlin")
