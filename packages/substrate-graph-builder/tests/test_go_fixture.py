"""Go fixture test — build_graph over tests/fixtures/go/ == expected.json."""
...
def test_go_fixture_matches_golden(load_fixture: LoadFixtureFn) -> None:
    root, tree = load_fixture("go")
